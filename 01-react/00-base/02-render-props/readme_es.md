...
Veamos que tal de reusable es la render prop que hemos creado, vamos a recrear
el mismo comportamiento para el segundo campo de tensión arterial, si está
