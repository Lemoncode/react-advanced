...
Un requisito muy común es el tener que implementar Drag & Drop en nuestra aplicación (Kanban, calendarios, ...)
...
En este ejercicio vamos a implementar un Kanban simple usando React Dnd
